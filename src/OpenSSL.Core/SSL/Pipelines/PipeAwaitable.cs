...
namespace OpenSSL.Core.SSL.Pipelines
{
    ...
    internal struct PipeAwaitable
    {
        ...
        internal CanceledState _canceledState;
        internal Action<object> _completion;
        internal object _completionState;
        ...
        public void Copy(in PipeAwaitable pipeAwaitable)
        {
            this._canceledState = pipeAwaitable._canceledState;
            this._completion = pipeAwaitable._completion;
            this._completionState = pipeAwaitable._completionState;
            this._cancellationToken = pipeAwaitable._cancellationToken;
            this._cancellationTokenRegistration = pipeAwaitable._cancellationTokenRegistration;
            this._synchronizationContext = pipeAwaitable._synchronizationContext;
            this._executionContext = pipeAwaitable._executionContext;
            this._useSynchronizationContext = pipeAwaitable._useSynchronizationContext;
        }

        internal enum CanceledState
        {
            NotCanceled = 0,
